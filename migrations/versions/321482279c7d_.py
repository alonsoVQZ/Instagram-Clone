...
Revision ID: 321482279c7d
Revises: 
Create Date: 2023-03-08 13:42:07.907987
...
def upgrade():
    ...
    op.create_table('Products_Medias',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('product_id', sa.Integer(), nullable=False),
    ...
    if environment == "production":
        op.execute(f"ALTER TABLE Products_Medias SET SCHEMA {SCHEMA};")
